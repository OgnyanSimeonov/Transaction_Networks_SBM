...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  4 22:51:37 2023
...
state = gt.minimize_blockmodel_dl(g, state_args=dict(eweight = weight))  # Perform weighted clustering
#, multilevel_mcmc_args=dict(B_max=7)
state.draw(vertex_font_size=12, vertex_text=postcode_bank, edge_pen_width=1.5,
           output_size=(10000, 10000), vertex_color="black", output="HSBC_states.png")
